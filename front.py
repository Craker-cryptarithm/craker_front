...
##問題作成ボタン作成
button_problem = tk.Button(root, text = "問題を作成！", bg = "#b7efcd", fg = "#633a82")
...
##答えを見るボタンを作成
button_ans = tk.Button(root, text = "答えを見る！", bg = "#b7efcd", fg = "#633a82")
...
##使い方ボタン
button_readme = tk.Button(root, text = "使い方を見る", bg = "#b7efcd", fg = "#633a82")
